...
*/
if("undefined"==typeof akeeba)var akeeba={};"undefined"==typeof akeeba.Fsfilters&&(akeeba.Fsfilters={currentRoot:null});akeeba.Fsfilters.activeRootChanged=function(){var c=document.getElementById("active_root"),a={};a.root=c.options[c.selectedIndex].value;a.crumbs=[];a.node="";akeeba.Fsfilters.load(a)};akeeba.Fsfilters.activeTabRootChanged=function(){var c=document.getElementById("active_root");akeeba.Fsfilters.loadTab(c.options[c.selectedIndex].value)};
akeeba.Fsfilters.load=function(c){c.verb="list";c=JSON.stringify(c);var a={};a.akaction=c;akeeba.System.doAjax(a,function(c){akeeba.Fsfilters.render(c)},null,!1,15E3)};
...
e;akeeba.System.data.set(a,"iconClass",null);akeeba.System.data.set(a,"loading",null)}!0==b.success?(null!=a&&g&&(!0==b.newstate?(akeeba.System.removeClass(a,"akeeba-btn--grey"),akeeba.System.addClass(a,"akeeba-btn--orange")):(akeeba.System.removeClass(a,"akeeba-btn--orange"),akeeba.System.addClass(a,"akeeba-btn--grey"))),null!=f&&f(b,a)):(null!=f&&f(b,a),akeeba.System.modalErrorHandler(akeeba.System.Text._("COM_AKEEBA_FILEFILTERS_LABEL_UIERRORFILTER").replace("%s",c.node)))},function(b){if(null!=
...
a.children[d].querySelector("span."+c),g=-1!=f.parentNode.className.indexOf("akeeba-btn--orange");!e&&!g||e&&g||akeeba.System.triggerEvent(f,"click")}}}(b,k));g.appendChild(b);akeeba.Tooltip.simpleTooltip(b)}b=document.createElement("span");b.className="folder-name";b.innerHTML='<span class="pull-left akion-arrow-down-a"></span>'+akeeba.System.Text._("COM_AKEEBA_FILEFILTERS_TYPE_APPLYTOALLDIRS");g.appendChild(b);a.appendChild(g)}for(var h in c.folders){if(!c.folders.hasOwnProperty(h))return;g=c.folders[h];
uielement=document.createElement("div");uielement.className="folder-container";f=["directories","skipdirs","skipfiles"];for(d=0;d<f.length;d++){e=f[d];b=document.createElement("span");b.className="akeeba-btn--mini akeeba-btn--grey folder-icon-container";b.setAttribute("title",'<div class="tooltip-arrow-up-leftaligned"></div><div>'+akeeba.System.Text._("COM_AKEEBA_FILEFILTERS_TYPE_"+e.toUpperCase())+"</div>");switch(e){case "directories":b.insertAdjacentHTML("beforeend",'<span class="ak-toggle-button akion-close-circled"></span>');
...
"akeeba-btn--orange");case 0:akeeba.System.addEventListener(b,"click",function(b,a,e){return function(){akeeba.Fsfilters.toggle({root:c.root,crumbs:crumbs,node:b,filter:a,verb:"toggle"},e)}}(h,e,b))}uielement.appendChild(b)}b=document.createElement("span");b.textContent=h;b.className="folder-name";akeeba.System.addEventListener(b,"click",function(b){return function(){var a=document.createElement("img");a.setAttribute("src",akeeba.System.getOptions("akeeba.Fsfilters.loadingGif",""));a.setAttribute("width",
16);a.setAttribute("height",11);a.setAttribute("border",0);a.setAttribute("alt","Loading...");a.style.marginTop="3px";a.style.marginLeft="5px";this.appendChild(a);akeeba.Fsfilters.load({root:c.root,crumbs:crumbs,node:b})}}(h));uielement.appendChild(b);a.appendChild(uielement)}h=document.getElementById("files");h.innerHTML="";0<Object.keys(c.files).length&&(e=document.createElement("div"),e.className="file-header file-container",b=document.createElement("span"),b.className="file-icon-container akeeba-btn--mini akeeba-btn--grey",
b.insertAdjacentHTML("beforeend",'<span class="ak-toggle-button akion-close-circled"></span>'),b.setAttribute("title",'<div class="tooltip-arrow-up-leftaligned"></div><div>'+akeeba.System.Text._("COM_AKEEBA_FILEFILTERS_TYPE_FILES_ALL")+"</div>"),b.setAttribute("data-akeeba-tooltip-position","right"),akeeba.Tooltip.simpleTooltip(b),akeeba.System.addEventListener(b,"click",function(b){return function(){var b;-1!=this.className.indexOf("akeeba-btn--orange")?(akeeba.System.removeClass(this,"akeeba-btn--orange"),
akeeba.System.addClass(this,"akeeba-btn--grey"),b=!1):(akeeba.System.removeClass(this,"akeeba-btn--grey"),akeeba.System.addClass(this,"akeeba-btn--orange"),b=!0);for(var c=document.getElementById("files"),a=1;a<c.children.length;a++){var e=c.children[a].querySelector("span.akion-close-circled"),d=-1!=e.parentNode.className.indexOf("akeeba-btn--orange");!b&&!d||b&&d||akeeba.System.triggerEvent(e,"click")}}}(b)),e.appendChild(b),b=document.createElement("span"),b.className="file-name",b.innerHTML='<span class="pull-left akion-arrow-down-a"></span>'+
...
akeeba.Fsfilters.renderCrumbs=function(c){var a=[],f=[akeeba.System.Text._("COM_AKEEBA_FILEFILTERS_LABEL_UIROOT"),c.root,[],""];a.push(f);var g=0;if(0<c.crumbs.length)for(var d=[],g=0;g<c.crumbs.length;g++){var e=c.crumbs[g],f=[e,c.root,d.slice(0),e];a.push(f);d.push(e)}c=document.getElementById("ak_crumbs");c.innerHTML="";e=null;for(g=0;g<a.length;g++){var e=a[g],f=document.createElement("li"),b=document.createElement("a");b.setAttribute("href","javascript:");e[0]=e[0].replace("&lt;","<").replace("&gt;",
">");b.textContent=e[0];akeeba.System.addEventListener(b,"click",function(b){return function(){var a=document.createElement("img");a.setAttribute("src",akeeba.System.getOptions("akeeba.Fsfilters.loadingGif",""));a.setAttribute("width",16);a.setAttribute("height",11);a.setAttribute("border",0);a.setAttribute("alt","Loading...");a.style.marginTop="5px";a.style.marginLeft="5px";this.appendChild(a);akeeba.Fsfilters.load({root:b[1],crumbs:b[2],node:b[3]})}}(e));f.appendChild(b);e=document.createElement("span");
e.textContent="/";f.appendChild(e);c.appendChild(f)}return d};
...
f.className="folder-name folder-up";var g=document.getElementById("ak_crumbs").children;f.textContent="("+g[g.length-2].querySelector("a").textContent+")";akeeba.System.addEventListener(f,"click",function(){var a=document.getElementById("ak_crumbs").children;akeeba.System.triggerEvent(a[a.length-2].querySelector("a"),"click")});a.appendChild(f);c.appendChild(a)};
akeeba.System.documentReady(function(){var c=akeeba.System.getOptions("akeeba.FileFilters.guiData",null);null!==c&&("list"===akeeba.System.getOptions("akeeba.FileFilters.viewType")?(akeeba.Fsfilters.render(c),akeeba.System.addEventListener("active_root","change",akeeba.Fsfilters.activeRootChanged)):(akeeba.Fsfilters.renderTab(c),akeeba.System.addEventListener("active_root","change",akeeba.Fsfilters.activeTabRootChanged)),akeeba.System.addEventListener("comAkeebaFileFiltersNuke","click",function(){akeeba.Fsfilters.nuke();
